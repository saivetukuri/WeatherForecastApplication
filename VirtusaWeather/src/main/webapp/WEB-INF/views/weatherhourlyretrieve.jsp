...
for(var i=0;i<JSON.parse(sessionStorage.getItem('forecasthourly')).length;i++){
	...
	if(todaydate==hourdate){
		...
		document.getElementById("todayhourly").innerHTML+='<button type="button" class="hourly" data-toggle="collapse" style="background-color:#DEB887;" data-target="#demo'+i+'"><div style="display: flex;flex-wrap: wrap; align-items:center;"><div style="text-align:left;"><b>'+formattedTime+
