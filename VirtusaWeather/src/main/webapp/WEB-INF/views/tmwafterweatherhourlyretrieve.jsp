...
for(var i=${i};i<48;i++){
	...
	console.log(hourdate);
		...
		document.getElementById("tmwafterhourly").innerHTML+='<button type="button" class="hourly" data-toggle="collapse" style="background-color:#DEB887;" data-target="#demo'+i+'"><div style="display: flex;flex-wrap: wrap; align-items:center;"><div style="text-align:left;"><b>'+formattedTime+
