...
for(var i=${i};i<j;i++){
	...
	console.log(hourdate);
		...
		document.getElementById("tmwhourly").innerHTML+='<button type="button" class="hourly" data-toggle="collapse" style="background-color:#DEB887;" data-target="#demo'+i+'"><div style="display: flex;flex-wrap: wrap; align-items:center;"><div style="text-align:left;"><b>'+formattedTime+
	...
	document.getElementById("tmwafterhourlink").href="/tmwafterhourly?lat=${latitude}&lng=${longitude}&cityname=${cityname}&i="+i;
	var date=new Date(JSON.parse(sessionStorage.getItem('forecasthourly'))[i].dt*1000);
	document.getElementById("tmwafterhourbutton").innerHTML=days[date.getDay()];
