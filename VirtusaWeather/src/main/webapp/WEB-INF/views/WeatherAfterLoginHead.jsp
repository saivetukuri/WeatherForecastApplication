...
<nav class="navbar navbar-expand-md navbar-dark bg-dark"  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="/weatherloghome" class="nav-item nav-link">Home</a>
            <a href="weatherlogout" class="nav-item nav-link">Logout</a>
 ...
 <div class="dropdown">
            ...
            <div class="dropdown-content">
    		<a href="/weather_forecast?lat=<%=session.getAttribute("latitude")%>&lng=<%=session.getAttribute("longitude")%>&cityname=<%=session.getAttribute("cityname")%>&units=metric" id="C">°C</a>
    		<a href="/weather_forecast?lat=<%=session.getAttribute("latitude")%>&lng=<%=session.getAttribute("longitude")%>&cityname=<%=session.getAttribute("cityname")%>&units=imperial" id="F">°F</a>
    		<a href="/weather_forecast?lat=<%=session.getAttribute("latitude")%>&lng=<%=session.getAttribute("longitude")%>&cityname=<%=session.getAttribute("cityname")%>&units=" id="K"> K</a>
 			 </div>
        </div>
    </div>
