...
document.getElementById('forecastdata').innerHTML+=' <div class="card" style="width:50%;margin: 0 auto;float: none;"><div style="display: flex;flex-wrap: wrap; align-items:center;">'+
