...
window.location.href = "/viewdeletedetails?email="+document.form1.email.value;
return true;
}
else
{
...
<form name="form1" action="viewdeletedetails" method="post" modelAttribute="customersearch">
