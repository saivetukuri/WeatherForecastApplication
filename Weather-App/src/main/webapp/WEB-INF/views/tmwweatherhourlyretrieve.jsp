...
for(var i=${i};i<j;i++){
	...
	console.log(hourdate);
		...
		document.getElementById("tmwhourly").innerHTML+='<button type="button" class="hourly" data-toggle="collapse"  data-target="#demo'+i+'"><div style="display: flex;flex-wrap: wrap; align-items:center;"><div style="text-align:left;"><b>'+formattedTime+
